...
public class main4 {
	public static void main(String args[]) {
		...
		// 객체 생성부
		Person p=new Person("안서준", "남자");
		Student stu=new Student("안서준", "남자", 19);
		
		p.setName("Ahnseojun");	// 이름 저장: 정상 실행
		// p.setNum(5381885);		// 학번 저장: 비정상 실행
		// Person 클래스는 Student 클래스 멤버 포함X
		stu.setName("Ahnseojun");	// 이름 저장: 정상 실행
		// 부모 클래스의 멤버를 복붙해서 자신의 것으로 만들었기 때문
		stu.setNum(5381885);	// 학번 저장: 정상 실행
